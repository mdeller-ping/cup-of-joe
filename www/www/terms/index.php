<?php
  ...
  $pingDirectoryHost = 'localhost:1443'; // hostname:http_port
  $pingDirectoryUser = 'cn=Administrator'; // PingDirectory user with ability to see consents
